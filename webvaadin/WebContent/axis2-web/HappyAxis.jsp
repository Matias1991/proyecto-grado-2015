...
%>
		<p>
			...
			present, there is no guarantee your Axis Service will work, because
			there are many configuration options that we do not check for. These
			tests are <i>necessary</i> but not <i>sufficient</i>
		</p>
	</blockquote>
...
%>
	<p>
		<font color="brown"> There was a problem in Axis2 version
			...
			some other service and check to see whether it is working. <br>
		</font>
	</p>
