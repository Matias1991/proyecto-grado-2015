...
public class CatalogCategoriesView extends BaseView {
	...
	public void buildGrid() {
		...
		if (categories != null && categories.size() > 0) {
			...
			categoriesGrid.getColumn("amountToShow").setHeaderCaption(
					"Importe sin IVA");
			...
			lblMessage
					.setValue("No hay rubros para mostrar para ese intervalo de fechas");
		}
	}
