...
public class CreateCategoryView extends BaseView {
	...
	public void buildGrid(){
		...
		if (categories != null && categories.size() > 0) {
			...
			projectsGrid.setWidth("400px");
			projectsGrid.setHeight("315px");
			projectsGrid.removeColumn("categoryTypeId");
			projectsGrid.removeColumn("categoryTypeToShow");
			projectsGrid.removeColumn("projectId");
			projectsGrid.setColumnOrder("id", "description", "amount", "categoryType");
	
			projectsGrid.getColumn("id").setHeaderCaption("Identificador");
			projectsGrid.getColumn("description").setHeaderCaption("Descripción");
			projectsGrid.getColumn("amount").setHeaderCaption("Monto");
			projectsGrid.getColumn("categoryType").setHeaderCaption("Asociado a");
	...
	private AbsoluteLayout buildMainLayout() {
		...
		popupDateField_1.setWidth("100.0%");
