...
public class CatalogProjectView extends BaseView {
	...
	private OptionGroup opgProjectStatus;
	...
	private void createCategoryGrid(
		...
		if (projectCategories != null && projectCategories.size() > 0) {
			...
			categoriesGrid.removeColumn("amountToShow");
			categoriesGrid.removeColumn("categoryTypeToShow");
			categoriesGrid.removeColumn("isDollarToShow");

			categoriesGrid.setColumnOrder("description", "totalAmountToShow",
	...
	private void createBillGrid(BeanItemContainer<Bill> projectBills) {
		if (projectBills != null && projectBills.size() > 0) {
			...
			billGrid.removeColumn("amountToShow");
			...
			billGrid.setColumnOrder("code", "description", "totalAmountToShow",
					"typeExchangeToShow");
			...
			billGrid.getColumn("totalAmountToShow").setHeaderCaption("Importe IVA incl.");
	...
	private AbsoluteLayout buildMainLayout() {
		...
		// opgProjectStatus
		opgProjectStatus = new OptionGroup();
		opgProjectStatus.setCaption("Estado");
		opgProjectStatus.setImmediate(true);
		opgProjectStatus.setVisible(true);
		opgProjectStatus.setWidth("-1px");
		opgProjectStatus.setHeight("-1px");
		...
		mainLayout.addComponent(tabProject, "top:155.0px;left:270.0px;");
