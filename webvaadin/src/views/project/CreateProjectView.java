...
public class CreateProjectView extends BaseView {
	...
	private void buildTables(){
		//tblEmployed		
		employedContainer = new BeanItemContainer<Employee>(Employee.class,EmployeeController.GetEmployees());
		...
		tblEmployed.setVisibleColumns("name","lastName","salarySummary.hours");
		...
		employedHoursContainer = new BeanItemContainer<Employee>(Employee.class,employedHoursCollection);
		employedHoursContainer.addNestedContainerProperty("salarySummary.hours");
		tblEmployedHours = new Table("Empleados asociados",employedHoursContainer);
		tblEmployedHours.setWidth("430px");
		tblEmployedHours.setHeight("160px");	
		tblEmployedHours.setVisibleColumns("name","lastName","salarySummary.hours");
	...
	private void loadComboBoxes(){
		...
		if(partners != null && partners.size()>0){
			for(User user : partners){
				...
				cboPartner1.setItemCaption(user.getId(),user.getName()+ " "+user.getLastName());
				cboPartner2.addItem(user.getId());				
				cboPartner2.setItemCaption(user.getId(),user.getName()+ " "+user.getLastName());
								
			}
			cboPartner1.setValue(partners.iterator().next().getId());
		}
		
		Collection<DistributionType> distributions = ProjectController.getDistributionTypes();
		...
		if(distributions != null && distributions.size()>0){
			for(DistributionType distribution : distributions){
				...
				cboDistribution1.setItemCaption(distribution.getId(),distribution.getValue());
				cboDistribution2.addItem(distribution.getId());			
				cboDistribution2.setItemCaption(distribution.getId(),distribution.getValue());
			}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(btnCreate,"top:484.0px;right:500.0px;left:0.0px;");
		...
		mainLayout.addComponent(btnCancel,"top:484.0px;right:340.0px;left:140.0px;");
		...
		mainLayout.addComponent(cboSeller, "top:180.0px;right:372.0px;left:3.0px;");
		...
		mainLayout.addComponent(cboManager, "top:245.0px;right:372.0px;left:3.0px;");	
		...
		mainLayout.addComponent(cboPartner1, "top:116.0px;right:372.0px;left:450.0px;");
		...
		mainLayout.addComponent(cboDistribution1, "top:180.0px;right:372.0px;left:450.0px;");	
		...
		mainLayout.addComponent(cboPartner2, "top:116.0px;right:372.0px;left:670.0px;");
		...
		mainLayout.addComponent(cboDistribution2, "top:180.0px;right:372.0px;left:670.0px;");
	...
	private boolean validate(){
		...
		if(!txtName.isValid() || !cboSeller.isValid() || !cboPartner1.isValid() || !cboDistribution2.isValid() || !cboPartner2.isValid() || !cboDistribution2.isValid()){
