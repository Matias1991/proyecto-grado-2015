...
public class ModifyUserView extends BaseView {
			...
			public void buttonClick(ClickEvent event) {
				...
				if (validateModifyUser()) {
					try {
						...
						new PopupWindow("AVISO", "Usuario modificado correctamente");
	...
	public void buildGrid(){
		...
		if(users != null && users.size() > 0){
			...
			modifyUserGrid.setWidth(458, Unit.PIXELS);
			...
			// Filtros
			HeaderRow filterRow = modifyUserGrid.appendHeaderRow();
			
			for (final Object pid : modifyUserGrid.getContainerDataSource()
				...
				if (cell != null) {
					...
					txtFilter.addTextChangeListener(new TextChangeListener() {
						...
						public void textChange(TextChangeEvent event) {
							...
							BeanItemContainer<User> container = ((BeanItemContainer<User>) modifyUserGrid
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(userLayout, "top:115.0px;left:485.0px;");
