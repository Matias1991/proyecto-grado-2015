...
public class CreateBillView extends BaseView {
		...
		btnCreate.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if (valid) {
					...
					bill.setProjectId(Integer.parseInt(cboxProject.getValue()
							.toString()));
	...
	private AbsoluteLayout buildMainLayout() {
		...
		strBuilder
				.append("<b>Importante:</b> La moneda de la factura depende de la moneda en la que este el proyecto.</br>");
