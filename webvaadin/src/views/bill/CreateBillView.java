...
public class CreateBillView extends BaseView {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(btnCreate, "top:434.0px;left:0.0px;");
		...
		mainLayout.addComponent(btnCancel, "top:434.0px;left:140.0px;");
		...
		mainLayout.addComponent(txtDescription, "top:185.0px;left:0.0px;");
		...
		mainLayout.addComponent(txtAmount, "top:314.0px;left:0.0px;");
		...
		mainLayout.addComponent(cboxProject, "top:249.0px;left:0.0px;");
		...
		mainLayout.addComponent(txtTypeExchange,
				"top:314.0px;right:265.0px;left:125px;");
		...
		mainLayout.addComponent(lblInfo, "top:100.0px;left:300.0px;");
