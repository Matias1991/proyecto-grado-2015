...
public class CreateUserView extends CustomComponent implements View {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(txt_createLastName, "top:176.0px;left:0.0px;");
		...
		mainLayout.addComponent(txt_email, "top:239.0px;left:0.0px;");
		...
		mainLayout.addComponent(btn_add, "top:434.0px;left:0.0px;");
		...
		mainLayout.addComponent(btn_cancel, "top:434.0px;left:139.0px;");

		// userType
		userType = new OptionGroup("Tipo de usuario");
		userType.addItems("Socio", "Gerente");
		mainLayout.addComponent(userType, "top:360.0px;left:60.0px;");
