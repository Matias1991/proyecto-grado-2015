...
public class DeleteEmployeeView extends BaseView {
		...
		btnDelete.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				ConfirmDialog.show(WebvaadinUI.getCurrent(), "Confirmación",
						"¿Desea eliminar el empleado seleccionado?", "Si",
							...
							public void onClose(ConfirmDialog confirm) {
								if (confirm.isConfirmed()) {
									BeanItem<Employee> item = beanContainer
											.getItem(grdGrid.getSelectedRow());

									if (EmployeeController.DeleteEmployee(item
											.getBean().getId())) {
										grdGrid.getContainerDataSource()
												.removeItem(
														grdGrid.getSelectedRow());
									}
	...
	public void buildGrid() {
		...
		if (employees != null && employees.size() > 0) {
			...
			grdGrid.getColumn("employedType").setHeaderCaption(
					"Tipo de empleado");
