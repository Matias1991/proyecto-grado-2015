...
public class CreateEmployeeView extends BaseView {
	...
	public CreateEmployeeView() {
		...
		//ObjectProperty<Double> doubleProperty = new ObjectProperty<Double>(0.0);
		//ObjectProperty<Integer> integerProperty = new ObjectProperty<Integer>(0);
		...
		//txtNominalSalary.setPropertyDataSource(doubleProperty);
		//txtNominalSalary.setLocale(Locale.ENGLISH);
		txtNominalSalary.setNullRepresentation("0");
		txtNominalSalary.setConvertedValue(0);
		...
		//txtTickets.setPropertyDataSource(new ObjectProperty<Double>(0.0));
		//txtTickets.setLocale(Locale.ENGLISH);
		txtTickets.setNullRepresentation("0");
		txtTickets.setConvertedValue(0);
		...
		//txtRet.setPropertyDataSource(doubleProperty);
		//txtRet.setLocale(Locale.ENGLISH);
		txtRet.setNullRepresentation("0");
		txtRet.setConvertedValue(0);
		...
		//txtIrpf.setPropertyDataSource(doubleProperty);
		//txtIrpf.setLocale(Locale.ENGLISH);
		txtIrpf.setNullRepresentation("0");
		txtIrpf.setConvertedValue(0);	
		...
		//txtBse.setPropertyDataSource(doubleProperty);
		//txtBse.setLocale(Locale.ENGLISH);
		txtBse.setNullRepresentation("0");
		txtBse.setConvertedValue(0);
		...
		//txtHours.setPropertyDataSource(integerProperty);
		//txtHours.setLocale(Locale.ENGLISH);
		txtHours.setNullRepresentation("0");
		txtHours.setConvertedValue(0);
		...
		//txtCostSaleHour.setPropertyDataSource(doubleProperty);
		//txtCostSaleHour.setLocale(Locale.ENGLISH);
		txtCostSaleHour.setNullRepresentation("0");
		txtCostSaleHour.setConvertedValue(0);
		...
		//txtPercentagePersonalFonasaContribution.setPropertyDataSource(doubleProperty);
		txtPercentagePersonalFonasaContribution.setLocale(Locale.ENGLISH);
		txtPercentagePersonalFonasaContribution.setNullRepresentation("0");
		txtPercentagePersonalFonasaContribution.setConvertedValue(0);
		...
		//txtPersonalRetirementContribution.setPropertyDataSource(doubleProperty);
		//txtPersonalRetirementContribution.setLocale(Locale.ENGLISH);
		txtPersonalRetirementContribution.setNullRepresentation("0");
		txtPersonalRetirementContribution.setConvertedValue(0);
		...
		//txtEmployerRetirementContribution.setPropertyDataSource(doubleProperty);
		//txtEmployerRetirementContribution.setLocale(Locale.ENGLISH);
		txtEmployerRetirementContribution.setNullRepresentation("0");
		txtEmployerRetirementContribution.setConvertedValue(0);
		...
		//txtPersonalFrlContribution.setPropertyDataSource(doubleProperty);
		////tPersonalFrlContribution.setLocale(Locale.ENGLISH);
		txtPersonalFrlContribution.setNullRepresentation("0");
		txtPersonalFrlContribution.setConvertedValue(0);
		...
		//txtEmployerFrlContribution.setPropertyDataSource(doubleProperty);
		//txtEmployerFrlContribution.setLocale(Locale.ENGLISH);
		txtEmployerFrlContribution.setNullRepresentation("0");
		txtEmployerFrlContribution.setConvertedValue(0);
		...
		//txtPersonalFonasaContribution.setPropertyDataSource(doubleProperty);
		//txtPersonalFonasaContribution.setLocale(Locale.ENGLISH);
		txtPersonalFonasaContribution.setNullRepresentation("0");
		txtPersonalFonasaContribution.setConvertedValue(0);
		...
		//txtEmployerFonasaContribution.setPropertyDataSource(doubleProperty);
		//txtEmployerFonasaContribution.setLocale(Locale.ENGLISH);
		txtEmployerFonasaContribution.setNullRepresentation("0");
		txtEmployerFonasaContribution.setConvertedValue(0);
		...
		//txtTicketsEmployer.setPropertyDataSource(doubleProperty);
		//txtTicketsEmployer.setLocale(Locale.ENGLISH);
		txtTicketsEmployer.setNullRepresentation("0");
		txtTicketsEmployer.setConvertedValue(0);
		...
		//txtTotalDiscounts.setPropertyDataSource(doubleProperty);
		//txtTotalDiscounts.setLocale(Locale.ENGLISH);
		txtTotalDiscounts.setNullRepresentation("0");
		txtTotalDiscounts.setConvertedValue(0);
		...
		//txtTotalEmployersContribution.setPropertyDataSource(doubleProperty);
		//txtTotalEmployersContribution.setLocale(Locale.ENGLISH);
		txtTotalEmployersContribution.setNullRepresentation("0");
		txtTotalEmployersContribution.setConvertedValue(0);
		...
		//txtNominalWithoutContribution.setPropertyDataSource(doubleProperty);
		//txtNominalWithoutContribution.setLocale(Locale.ENGLISH);
		txtNominalWithoutContribution.setNullRepresentation("0");
		txtNominalWithoutContribution.setConvertedValue(0);
		...
		//txtDismisalPrevension.setPropertyDataSource(doubleProperty);
		//txtDismisalPrevension.setLocale(Locale.ENGLISH);
		txtDismisalPrevension.setNullRepresentation("0");
		txtDismisalPrevension.setConvertedValue(0);
		...
		//txtIncidenceSalary.setPropertyDataSource(doubleProperty);
		//txtIncidenceSalary.setLocale(Locale.ENGLISH);
		txtIncidenceSalary.setNullRepresentation("0");
		txtIncidenceSalary.setConvertedValue(0);
		...
		//txtSalaryToPay.setPropertyDataSource(doubleProperty);
		//txtSalaryToPay.setLocale(Locale.ENGLISH);
		txtSalaryToPay.setNullRepresentation("0");
		txtSalaryToPay.setConvertedValue(0);
		...
		//txtCostMonth.setPropertyDataSource(doubleProperty);
		//txtCostMonth.setLocale(Locale.ENGLISH);
		txtCostMonth.setNullRepresentation("0");
		txtCostMonth.setConvertedValue(0);
		...
		//txtCostRealHour.setPropertyDataSource(doubleProperty);
		//txtCostRealHour.setLocale(Locale.ENGLISH);
		txtCostRealHour.setNullRepresentation("0");
		txtCostRealHour.setConvertedValue(0);
		...
		btnEstimate.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if (validateEstimateEmployee()){
					...
					estimateSalarySummary.setPercentageTypeFONASA((Double)txtPercentagePersonalFonasaContribution.getConvertedValue());
