...
public class ModifyUserView extends CustomComponent implements View {
	...
	public ModifyUserView() throws RemoteException {
		buildMainLayout();
		setCompositionRoot(mainLayout);
		
		ServiceWebStub uploadUser = new ServiceWebStub();
		//uploadUser.getUser(...);
		...
		btn_modify.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				ServiceWebStub modifyUserService;
					try {
						modifyUserService = new ServiceWebStub();
						...
						modifyUserService.updateUser(modifyUser);
					} catch (AxisFault e) {
						e.printStackTrace();
	...
	public void enter(ViewChangeEvent event) {
		...
		WebvaadinUI.setTitle("Modificar Usuario");
	...
	private AbsoluteLayout buildMainLayout() {
		...
		txt_lastName.setTabIndex(1);
		txt_lastName.setRequired(true);
		txt_lastName.setNullSettingAllowed(true);
		mainLayout.addComponent(txt_lastName, "top:183.0px;left:59.0px;");
		...
		mainLayout.addComponent(txt_email, "top:245.0px;left:60.0px;");
		...
		btn_modify.setTabIndex(6);
		mainLayout.addComponent(btn_modify, "top:304.0px;left:59.0px;");
		...
		mainLayout.addComponent(btn_cancel, "top:304.0px;left:200.0px;");
