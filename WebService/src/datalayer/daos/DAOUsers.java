...
public class DAOUsers implements IDAOUsers {
	...
	@Override
	public ArrayList<User> getUsersByTypeAndStatus(UserType userType,
	...
	public void update(int id, User obj) throws ServerException {
		...
		String updateSQL = "UPDATE USER " + "SET name = ?, " + "lastName = ?, "
				+ "email = ?, " + "userTypeId = ? " + "WHERE id = ?";
	...
	@Override
	public void update(int id, UserStatus userStatus, int attempts,
			Date lastAttemptDateTimeUTC) throws ServerException {

		PreparedStatement preparedStatement = null;

		String updateSQL = "UPDATE USER " + "SET attempts = ?, "
				+ "lastAttemptDateTimeUTC = ?, " + "userStatusId = ? "
				+ "WHERE id = ?";
		...
		try {
			...
			if (lastAttemptDateTimeUTC != null)
				_lastAttemptTimestamp = new Timestamp(
						lastAttemptDateTimeUTC.getTime());
	...
	public void updatePassword(int id, String newPassword)
		...
		String updatePasswordSQL = "UPDATE USER " + "SET password = ?"
				+ "WHERE id = ?";
	...
	@Override
	public ArrayList<User> getUsersByStatus(UserStatus userStatus)
			throws ServerException {
		ArrayList<User> users = new ArrayList<User>();
		PreparedStatement preparedStatement = null;
		ResultSet rs = null;
	...
	public ArrayList<User> getUsersByType(UserType userType)
		...
		try {
			...
			String getSQL = "SELECT * FROM USER WHERE userTypeId = ? ";
			preparedStatement = this.connection.prepareStatement(getSQL);
			preparedStatement.setInt(1, userType.getValue());
